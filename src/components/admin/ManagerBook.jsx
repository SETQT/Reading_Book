    ...
    return (
        <>
            <div>
                ...
                <div className='submitFormBook'>
                    <span id='submitBook' onClick={() => {
                        submitUpdateBook()
                        handleOnClick()
                    }
                    } style={{ cursor: "pointer" }}>SUBMIT</span>
                </div>
            </div>
        </>
    )
...
function ContentAddChapter(props) {
    ...
    const navigate = useNavigate();
    const handleOnClick = useCallback(() => navigate('../reported', { replace: true }), [navigate]);
    const handleOnClick2 = useCallback(() => navigate('../all', { replace: true }), [navigate]);
    return (
        <>
            <div>
                <div className='formBook'>
                    <div className='nameAddChapter'>
                        <label htmlFor="nameChapter" style={{ "flex": "1" }}>Name of Chapter:</label>
                    ...
                    <div className="descriptionFormBook">
                        ...
                        <textarea id='descriptionFormChapter' type="text" name="descriptionFormChapter" placeholder='Content' />
                    </div>
